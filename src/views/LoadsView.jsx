      ...
      {syncResult && (
        <div style={{
          ...
          <span>
            {syncResult.error
              ? <>⚠ {syncResult.error}</>
              : <>✅ Fetched {syncResult.fetched}{syncResult.apiTotal != null ? `/${syncResult.apiTotal}` : ""} loads · written {syncResult.report?.written} · skipped {syncResult.report?.skipped}{syncResult.report?.deleted > 0 ? ` · cleaned up ${syncResult.report.deleted}` : ""} · {syncResult.elapsedMs}ms</>}
          </span>
