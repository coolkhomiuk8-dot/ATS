// RingCentral helper — Emma HR's (ext. 106) own call stats for today.
// Used by _driver-analytics.js (evening HR digest).
//
// Multi-account / whole-team call stats now live on a separate Netlify site
// (../call-stats-bot) — tracking two RC accounts alongside this site's
// Firebase credentials blows AWS Lambda's 4KB env-var cap. See truck-bot.js's
// /calls command, which calls out to that site instead.
